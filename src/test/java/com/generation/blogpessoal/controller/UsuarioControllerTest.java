...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Helena", "helena@email.com.br", "12345678", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(
				new Usuario(0L, "Juliana Oliveira", "juliana_oliveira@email.com.br", "Juliana123", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Oliveira Alves",
				"juliana_alves@email.com.br", "Juliana123", "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Elyse Hrist", "elyse_hrist@email.com.br", "Lys456", "-"));

		usuarioService
				.cadastrarUsuario(new Usuario(0L, "Clessidra Strange", "strange@email.com.br", "strange123", "-"));
